...
## 📂 Project Structure
movie-sentiment-analysis-python/
│
├── app.py
├── movie_reviews.csv
├── users.csv
...
1. Clone the repository:
  git clone https://github.com/UtkarshPardhi/movie-sentiment-analysis-python.git

2. Navigate to the project directory:
  cd movie-sentiment-analysis-python
...
➡️Analyze user-submitted movie reviews
➡️Understand public opinion trends
➡️Learn sentiment analysis basics using Python

🎯 Learning Outcomes

➡️Python web application development
➡️Sentiment analysis fundamentals
➡️Handling CSV data in Python
➡️User authentication flow
